...
export function ContactPage() {
  ...
  const faqs = Array.isArray(t("contact.faqs", []))
    ? t("contact.faqs", [])
    : [];
  ...
  const validate = () => {
    ...
    if (!form.phone || form.phone === "+91 ")
      errs.phone = t("contact.validation.phone");
    if (!emailValue) errs.email = t("contact.validation.email");
    else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(emailValue))
      errs.email = t("contact.validation.emailFormat");
  ...
  const baseInput =
    "w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[var(--accent-orange)] focus:outline-none focus:ring-2 focus:ring-[var(--accent-orange)] focus:ring-opacity-20 transition-all";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{
          ...
          backgroundImage:
            "radial-gradient(circle, rgba(46,94,170,0.08) 1px, transparent 1px)",
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-xl border border-gray-100">
              ...
              <p
                className="mb-8"
                style={{ fontSize: "15px", color: "var(--dark-gray)" }}
              >
              ...
              <form onSubmit={onSubmit} className="space-y-5">
                <div>
                  ...
                  >
                    {t("contact.fullName")}{" "}
                    <span style={{ color: "var(--gradient-red)" }}>
                      {t("common.required")}
                    </span>
                  </label>
                  <input
                ...
                <div>
                  ...
                  >
                    <option value="">
                      {t("contact.machineOptions.select")}
                    </option>
                    <option value="high-speed">
                      {t("contact.machineOptions.highSpeed")}
                    </option>
                    <option value="sequins">
                      {t("contact.machineOptions.sequins")}
                    </option>
                    <option value="beads">
                      {t("contact.machineOptions.beads")}
                    </option>
                    <option value="coding">
                      {t("contact.machineOptions.coding")}
                    </option>
                    <option value="multi-function">
                      {t("contact.machineOptions.multiFunction")}
                    </option>
                    <option value="guidance">
                      {t("contact.machineOptions.guidance")}
                    </option>
                  </select>
                </div>
                <div>
                  ...
                  <select
                    ...
                    onChange={onChange}
                    className={baseInput}
                    style={inputStyle("helpType")}
                  >
                    <option value="">{t("contact.helpOptions.select")}</option>
                    <option value="quote">
                      {t("contact.helpOptions.quote")}
                    </option>
                    <option value="demo">
                      {t("contact.helpOptions.demo")}
                    </option>
                    <option value="support">
                      {t("contact.helpOptions.support")}
                    </option>
                    <option value="service">
                      {t("contact.helpOptions.service")}
                    </option>
                    <option value="inquiry">
                      {t("contact.helpOptions.inquiry")}
                    </option>
              ...
              {[
                {
                  ...
                  sub: t("footer.businessHours"),
                  href: buildTelUrl(SUPPORT_PHONE_DISPLAY),
                  ic: "var(--accent-orange)",
                  bg: "rgba(46,94,170,0.05)",
                },
                {
                  Icon: MessageCircle,
                  label: t("contact.whatsApp"),
                  value: SUPPORT_PHONE_DISPLAY,
                  sub: t("contact.quickResponse"),
                  href: buildWhatsAppUrl(SUPPORT_PHONE_DISPLAY),
                  ic: "#25D366",
                ...
                >
                  <div className="flex items-start gap-4">
                    <div
                      className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110 group-hover:animate-pulse"
                    ...
                    <div>
                      ...
                      <p
                        style={{ fontSize: "13px", color: "var(--dark-gray)" }}
                      >
                        {sub}
                      </p>
                    </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p
                      ...
                      style={{ color: "var(--charcoal)", fontSize: "16px" }}
                    >
                      {t("contact.businessHours")}
                    </p>
                    <p style={{ color: "var(--dark-gray)", fontSize: "14px" }}>
                      <strong>{t("contact.monSat")}</strong>{" "}
                      {t("contact.monSatTime")}
                    </p>
                    <p style={{ color: "var(--dark-gray)", fontSize: "14px" }}>
                      <strong>{t("contact.sunday")}</strong>{" "}
                ...
                <div className="flex gap-3">
                  {[
                    [
                      Facebook,
                      "#1877F2",
                      "https://www.facebook.com/profile.php?id=61561041652772",
                    ],
                    [
                      Instagram,
                      "#E4405F",
                      "https://www.instagram.com/zmslizza/",
                    ],
                    [
                      Linkedin,
                      "#0A66C2",
                      "https://www.linkedin.com/in/zms-lizza-326090321/",
                    ],
                    [
                      Youtube,
                      "#FF0000",
                      "https://www.youtube.com/channel/UC5nDi6xYVXedojHpVbSPQew",
                    ],
                  ].map(([Icon, color, to], i) => (
                    <a
                      key={i}
      ...
      <section className="py-12 bg-white">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          <div
            className="rounded-2xl overflow-hidden shadow-xl p-[2px]"
            style={{
              background:
                "linear-gradient(90deg, var(--gradient-red), var(--gradient-purple), var(--gradient-blue))",
            }}
          >
            ...
            {faqs.map((faq, i) => (
              ...
              >
                <button
                  ...
                  style={{
                    backgroundColor:
                      openFAQ === i ? "var(--light-gray)" : "white",
                  }}
                >
                  <span
                    style={{
                  ...
                  <div
                    className="w-8 h-8 rounded-full flex items-center justify-center ml-4 flex-shrink-0 transition-transform duration-300"
                    style={{
                      backgroundColor:
                        openFAQ === i
                          ? "var(--accent-orange)"
                  ...
                  >
                    {openFAQ === i ? (
                      ...
                      <Plus size={18} style={{ color: "var(--dark-gray)" }} />
                    )}
                  </div>
                </button>
                {openFAQ === i && (
