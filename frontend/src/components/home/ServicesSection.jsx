...
const SERVICES = [
  {
    Icon: Settings,
    title: 'Machine Installation and Setup',
    description: 'Professional installation at your factory with complete testing and calibration. Our expert technicians ensure your machine is production-ready from day one.',
    color: 'var(--gradient-blue)',
  },
  {
    Icon: GraduationCap,
    title: 'On-Site Operator Training',
    description: 'Comprehensive hands-on training for your team covering operation, maintenance basics, and troubleshooting to maximize productivity.',
    color: 'var(--gradient-purple)',
  },
  {
    Icon: Wrench,
    title: 'Maintenance and Technical Support',
    description: 'Regular maintenance and 24/7 technical support. Fast response times and genuine spare parts keep machines running at peak performance.',
    color: 'var(--accent-orange)',
  },
  {
    Icon: ShieldCheck,
    title: 'Warranty and After-Sales Service',
    description: 'Comprehensive warranty coverage and dedicated after-sales support. We stand behind our machines with reliable service.',
    color: 'var(--gradient-red)',
  },
  {
    Icon: CreditCard,
    title: 'EMI and Subsidy Assistance',
    description: 'Flexible financing options and help with government subsidy applications. Easy EMI plans to make your investment affordable.',
    color: 'var(--gradient-blue)',
  },
]
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-24">
          {SERVICES.map(({ Icon, title, description, color }, index) => (
            <div key={title} className={`grid lg:grid-cols-2 gap-12 items-center ${index % 2 === 0 ? '' : 'lg:grid-flow-dense'}`}>
              <div className={index % 2 === 0 ? 'lg:col-start-2' : 'lg:col-start-1'}>
                <div className="relative rounded-2xl overflow-hidden shadow-xl">
                  <img src={IMG} alt={title} className="w-full h-[280px] md:h-[400px] object-cover" />
